...
vw* parse_args(int argc, char *argv[])
{
  ...
  desc.add_options()
    ...
    ("omp", "Run orthogonal matching pursuit for feature selection")
    ("omp_k", po::value<size_t>(), "Number of features to select with OMP")
    ("omp_num_model_passes", po::value<size_t>(), "Number of passes to train model for before adding a new feature in OMP mode")
    ("omp_num_model_examples", po::value<size_t>(), "Number of examples to train model for before adding a new feature in OMP mode")
    ("omp_num_gradient_examples", po::value<size_t>(), "Number of examples to estimate gradient in OMP mode")
    ("omp_save_per_feature", "Save a copy of the model after each feature is added")
